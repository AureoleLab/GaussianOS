...
Rectangle {
    ...
    property var project: ({
        "name":"Atrium Capture","status":"Ready","group":"active",
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StatusBadge {
                    theme: root.theme
                    type: root.type
                    text: (root.project.status || "Ready").toUpperCase()
            ...
            ColumnLayout {
                ...
                ToolbarButton {
                    ...
                    text: "Open directory"
                    iconName: "folder"
                    onClicked: root.actionRequested("Mock action · opened " + root.project.name + " directory")
                }
                RowLayout {
                    Layout.fillWidth: true
                    spacing: theme.density.itemGap
                    ...
                    ToolbarButton {
                        ...
                        text: "Duplicate"
                        iconName: "copy"
                        onClicked: root.actionRequested("Mock action · duplicated " + root.project.name)
                    }
                }
                ToolbarButton {
                    ...
                    iconName: "archive"
                    onClicked: root.actionRequested("Mock action · archived " + root.project.name)
                }
                ToolbarButton {
                    ...
                    iconName: "restore"
                    onClicked: root.actionRequested("Mock action · restored " + root.project.name)
                }
                ToolbarButton {
                    visible: root.project.group === "trash"
                    theme: root.theme; type: root.type
