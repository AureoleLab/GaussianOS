...
Popup {
    ...
    property int dialogMaxHeight: parent ? parent.height - 40 : 760
    ...
    implicitHeight: Math.min(shell.implicitHeight, dialogMaxHeight)
    ...
    contentItem: ColumnLayout {
        ...
        ScrollView {
            ...
            Layout.preferredHeight: Math.min(
                bodyColumn.implicitHeight + 40,
                root.dialogMaxHeight - headerRow.implicitHeight - 30
            )
            padding: 20
            clip: true
